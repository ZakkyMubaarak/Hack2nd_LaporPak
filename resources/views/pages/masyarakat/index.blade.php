  ...
  <div class="container px-6 mx-auto grid">
    ...
    <form action="{{ route('pengaduan.store')}} " method="POST" enctype="multipart/form-data">
      ...
      <div class="px-4 py-3 mb-8 bg-red-300 rounded-lg shadow-xl border-2 dark:bg-gray-800">
        ...
        <input type="text" name="location" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-red-400 focus:outline-none focus:shadow-outline-red dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="Isi Link Maps lokasi kejadian">
        ...
        <label for="image" class="block mt-4 text-sm">
          ...
          @if (old('image') || isset($imagePath))
              <div class="mt-2">
                  <img src="{{ old('image') ? old('image') : asset($imagePath) }}" alt="Foto Sebelumnya" class="h-32 w-32 object-cover rounded-md" />
              </div>
          @endif
      </label>
